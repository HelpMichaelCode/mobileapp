    ...
    const [ populateEditModal, setPopulateEditModal ] = useState({
        ...
        const updateDrink = (e) =>
        {
          ...
          .then(res => {
            ...
            setDrinkCollection([...collectionOfDrinks.filter((drink) => drink.id !== populateEditModal.id)]);
            setDrinkCollectionFull([...collectionOfDrinksFull.filter((drink) => drink.id !== populateEditModal.id)]);
          })
          .catch(err => console.log(err));
        }
